...
$string['unit_in'] = 'Inch';
$string['noexportpatterns'] = 'Export excluded patterns';
$string['noexportpatterns_help'] = 'List of patterns to exclude from the pdf exported file (one pattern per line). This list may be particularly useful when the pdf view is used for entry adding/editing.';
/* PDF Frame */
